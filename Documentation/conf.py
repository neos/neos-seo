...
# The suffix(es) of source filenames, mapped to their parser type.
...
# built documents.
#
# Read the Docs exports the branch or tag being built as READTHEDOCS_GIT_IDENTIFIER
# (e.g. '5.4', '6.1.1', 'main'). Builds outside Read the Docs show 'dev'.
# Both version and release use the short X.Y form, so a tag like '6.1.1' becomes '6.1'.
version = release = '.'.join(os.environ.get('READTHEDOCS_GIT_IDENTIFIER', 'dev').split('.')[:2])
...
# For "manual" documents, use parts (not chapters) as toplevel headings.
